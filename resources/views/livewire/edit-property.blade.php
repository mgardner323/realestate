    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-sm text-gray-500 mt-1">Update the property information below.</p>
            </div>
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <button type="button" 
                                ...
                                class="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-3 py-1 rounded-md hover:from-purple-700 hover:to-blue-700 transition-all duration-200 flex items-center gap-2 text-xs">
